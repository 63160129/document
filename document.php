...
<div class="container mt-3">
  ...
  <p>&nbsp;รายการคำสั่งแต่งตั้ง</p> 
  <form class="d-flex" >
        <input class="form-control me-2" type="text" placeholder="ค้นหา &hearts;" style = " width: 163px; height: 25px;">
        <button class="btn btn-secondary" type="submit">Search</button>
        <a class="nav-link " href="newdocument.php">เพิ่มคำสั่ง &nbsp;<span class='glyphicon glyphicon-plus'></span></a>
  ...
  <ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link active" href="#">คำสั่งแต่งตั้ง</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="staff.php">บุคลากร</a>
    </li>
    <li class="nav-item">
      <a class="nav-link " href="selectdocument.php">ค้นหารายชื่อ</a>
    </li>
  </ul>
  <br>
  <?php    
